(function (context, factory) {
    ...
    var KeyboardJS = {}, locales = {}, locale, map, macros, activeKeys = [],
        bindings = [],
        activeBindings = [],
        activeMacros = [],
        aI, usLocale;
    ...
    function createBinding(keyCombo, keyDownCallback, keyUpCallback) {
        var api = {}, binding, subBindings = [],
            bindingApi = {}, kI, subCombo;
    ...
    function executeBindings(event) {
        var bI, sBI, binding, bidningKeys, remainingKeys, cI, killEventBubble, kI, bindingKeysSatisfied, index, sortedBindings = [],
            bindingWeight;
